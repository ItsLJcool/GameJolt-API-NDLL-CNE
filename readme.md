...
I do this to all my API stuff (Like my LJ Arcade API scripts) so im going to force you to do the same. Though please credit me for giving you this knowledge because it so easy. 🙏
...
public function gamejolt_init() {
    ...
    NdllUtil.getFunction(ndllName, "set_ndll_name", 1)(ndllName); // for internal use
